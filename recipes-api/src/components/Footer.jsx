                 ...
                 Carlos Romero.
                    ...
                    <ul className="flex justify-end items-center text-sm font-medium text-white sm:mt-0">
                            ...
                            <li className="me-3 hover:text-blue-600">
                                <a  href="https://www.linkedin.com/in/carlos-romero-626b08287/?midSig=1Z1kJh0-MLIHU1&eid=jcqzcu-mewyzutr-tf&midToken=AQG3u-MiUKDL8A&trkEmail=eml-security_two_step_verification_login_attempt-header-0-profile_glimmer-null-jcqzcu%7Emewyzutr%7Etf-null-null&trk=eml-security_two_step_verification_login_attempt-header-0-profile_glimmer&originalSubdomain=co" target="_blank">Linkedin</a>
                                <svg className="inline mr-3 ml-1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-linkedin-icon lucide-linkedin"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect width="4" height="12" x="2" y="9"/><circle cx="4" cy="4" r="2"/></svg>
                            </li>
                            <li className="me-3 hover:text-blue-600">
                                <a href="hhttps://mail.google.com/mail/u/0/#inbox" 
                                    target="_blank" 
                                >Gmail</a>
                                <svg href="hhttps://mail.google.com/mail/u/0/#inbox"  className="inline mr-3 ml-1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-mail-plus-icon lucide-mail-plus"><path d="M22 13V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v12c0 1.1.9 2 2 2h8"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/><path d="M19 16v6"/><path d="M16 19h6"/></svg>
                            </li>
                        </ul>
            </div>
        </footer>
