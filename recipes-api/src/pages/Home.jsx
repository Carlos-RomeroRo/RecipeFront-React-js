...
export default function Home() {
  return <div>
    ...
    <Reveal>
      ...
      <div className="flex flex-wrap justify-center gap-8">  {/* Contenedor de las tarjetas */}
          
              <div class="max-w-sm  border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 mt-16 justify-center items-center mx-auto slide-top">
                        <a href="#">
                        ...
                        <div class="p-5">
                            <a href="#">
                                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Alitas de Pollo a la Parrilla</h5>
                            </a>
              ...
              <div class="max-w-sm  border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 mt-16 justify-center items-center mx-auto slide-top">
                  ...
                  <div class="p-5">
                      <a href="#">
                          <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Postre de Fresas</h5>
                      </a>
              ...
              <div class="max-w-sm  border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 mt-16 justify-center items-center mx-auto flip-up">
                  <a href="#">
                  ...
                  <div class="p-5">
                      <a href="#">
                          <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Pizza de Pepperoni</h5>
                      </a>
